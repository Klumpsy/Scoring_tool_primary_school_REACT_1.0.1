...
export const rekenenSliderValue = state => state.students.snappetSliderRekenen;
export const taalSliderValue = state => state.students.snappetSliderTaal;
export const spellingSliderValue = state => state.students.snappetSliderSpelling;
export const rekenenSliderValue2 = state => state.students.snappetSliderRekenen2;
export const taalSliderValue2 = state => state.students.snappetSliderTaal2;
export const spellingSliderValue2 = state => state.students.snappetSliderSpelling2;
